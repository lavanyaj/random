...
plot "11T10h.dat" using 2 title 'cp(S2/S1)',  "11T10h.dat" using 3 title 'cp(S3/S2)', "11T10h.dat" using 4 title 'cp(S4/S3)', "11T10h.dat" using 5 title 'cp(S5/S4)', "11T10h.dat" using 6 title 'cp(S6/S5)', "11T10h.dat" using 7 title 'cp(S7/S6)', "11T10h.dat" using 8 title 'cp(S8/S7)', "11T10h.dat" using 9 title 'cp(S9/S8)', "11T10h.dat" using 10 title 'cp(S10/S9)',  9.96 title '3lg10'
#    EOF
